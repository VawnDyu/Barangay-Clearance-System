...
Public Class AddResident
    ...
    Dim tempcivilstatus As String
    Dim tempvoterstatus As String
    ...
    Sub AddResident()
        ...
        Try
            ...
            If StatusSingle.Enabled = True And
                ...
                ErrorCivilStatus.Text = "Please select your Civil Status"
            ...
            If tempfirstname <> "First Name" And
                ...
                Query = ("INSERT INTO barangay.residents(firstname,middlename,lastname,streetno,street,gender,birthdate,civilstatus,voterstatus,contactnumber) VALUES ('" & tempfirstname & "','" & tempmiddlename & "','" & templastname & "','" & tempstreetno & "','" & tempstreet & "','" & tempgender & "','" & tempbirthdate & "','" & tempcivilstatus & "','" & tempvoterstatus & "','" & tempcontactnumber & "')")
