...
Partial Class VoidMessage2
    ...
    Private Sub InitializeComponent()
        ...
        Dim resources As $safeprojectname$.ComponentModel.ComponentResourceManager = New $safeprojectname$.ComponentModel.ComponentResourceManager(GetType(VoidMessage2))
